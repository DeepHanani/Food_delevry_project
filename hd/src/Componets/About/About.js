...
export default function About() {
  return (
    ...
    <div className='provideImg'></div>
    <div className='provideContaint'>
    <h2>Leave a Mark</h2>
       <p>
           ...
           and must be backed. Our people - backed by our
           culture of end-to-end ownership - have revolutionised
           India's e-commerce sector - several times over! We believe great ideas can emerge from anywhere
           and must be backed. Our people - backed by our
           culture of end-to-end ownership - have revolutionised
           India's e-commerce sector - several times over!
    ...
    <div className='adviceContaint'>
    <h2>Experiment Learn Grow</h2>
            ...
            and a growth orientation built into everything we do.
            Whether it be opening a new warehouse, or making
            our mobile app a bit more consumer friendly.
            </p>
    </div>
    <div className='adviceImg'></div>
    </div>
